                                ...
                                user : function(callback){
                                    ...
                                    new user(mydata).save().then((data)=>{
                                        ...
                                        const mailOptions = {
                                            ...
                                            html:'<p>Hello '+mydata.user_name+'</p><p>your user_id and password for <strong>Gero Estate<strong></p><p>Your Email: <span> '+ mydata.email+'</span></p><p>your password :<span>'+req.body.pass+'</span></p><a style="border:1px solid gray;color:white; border-radius:4px; padding-top:10px;padding-bottom:10px;padding-left:5px;padding-right:5px; text-decoration:none;;background-color:#ff8000;" href="https://nameless-bayou-49909.herokuapp.com/api/activateAccount/'+mydata.email+'?account_status='+1+'" >Activate your Account</a> <p>  </p>'
        ...
        user.findOne({email:req.body.email}).then((data)=>{
            ...
            if(data!=null){
                ...
                var mailOptions = {
                    ...
                    html: '<b>Hello world?</b><br><a href="https://warm-lowlands-23243.herokuapp.com/changepassword?email='+data.email+'">My web</a>'
                };
                transporter.sendMail(mailOptions, function (error, info) {
                    if (error) {
                        console.log(error);
...
module.exports.Exmple= async (req,res)=>{
